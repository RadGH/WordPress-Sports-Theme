...
Functions:
	...
	class Forest_Walker_Nav_Menu
	custom_nav_menu_args( $args )
	custom_menu_item_id_class( $menu_items, $args )
	...
	custom_menu_separators( $menu_items, $args )
...
// Use the Forest walker for nav menus by default.
...
add_action( 'wp_nav_menu_objects', 'custom_menu_item_id_class', 10, 2 );
...
// add_action( 'wp_nav_menu_objects', 'custom_menu_separators' );
